...
const AdminPerfilPage = () => {
  ...
  // ========================================================
  // LÓGICA PARA SUBIR FOTO CON TU PerfilControlador.java
  // ========================================================
  const handlePhotoUpload = async (e) => {
    ...
    try {
      ...
      // Llamamos al endpoint que tú mismo creaste en PerfilControlador
      ...
      // Actualizamos el almacenamiento local para que la barra de arriba también cambie
      localStorage.setItem("usuarioFoto", nuevaFotoUrl);
      
      // Forzamos una recarga limpia para que toda la interfaz se entere de la nueva foto
  ...
  // ========================================================
  // LÓGICA PARA GUARDAR LOS DATOS DE TEXTO
  // ========================================================
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Actualizamos el storage por si cambió su nombre o correo
      ...
      window.location.reload(); // Recarga para actualizar la cabecera superior
    } catch (error) {
      console.error(error);
