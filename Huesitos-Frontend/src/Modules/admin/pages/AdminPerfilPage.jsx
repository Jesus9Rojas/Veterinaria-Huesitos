      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200/60 shadow-sm flex flex-col md:flex-row items-center gap-6">
        <div className="relative group">
          ...
          <button 
            ...
            className="absolute bottom-0 right-0 p-2.5 bg-gradient-to-tr from-sky-500 to-cyan-400 text-white rounded-full shadow-lg border-2 border-white hover:scale-110 transition-transform disabled:opacity-50" title="Cambiar foto de perfil"
          >
            <Camera size={16} />
          </button>
